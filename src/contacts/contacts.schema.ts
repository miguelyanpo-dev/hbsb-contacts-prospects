...
export const ContactListItemSchema = z.object({
  ...
  total_amount_all_invoices: z.number(),
  ...
  created_by_user_id: z.union([z.number().int(), z.string()]).nullable(),
  updated_at: z.string().nullable(),
  updated_by_user_id: z.union([z.number().int(), z.string()]).nullable(),
});
...
export const ContactSchema = z.object({
  ...
  deleted_by_user_id: z.union([z.number().int(), z.string()]).nullable(),
  /** Solo si existen columnas en BD (no se incluyen en SELECT de detalle por compatibilidad multi-tenant). */
  is_in_external_software: z.boolean().nullish(),
  id_seller: z.union([IdContactSchema, z.string()]).nullish(),
  id_status_customer: z.union([IdContactSchema, z.string()]).nullish(),
  id_status_prospect: z.union([IdContactSchema, z.string()]).nullish(),
  id_status_supplier: z.union([IdContactSchema, z.string()]).nullish(),
  id_status_employee: z.union([IdContactSchema, z.string()]).nullish(),
  id_status_seller: z.union([IdContactSchema, z.string()]).nullish(),
});
